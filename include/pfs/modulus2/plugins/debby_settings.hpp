...
//
// Changelog:
//      2021.09.12 Initial version (as `rocksdb_settings_plugin`).
//      2022.03.14 Refactored.
//      2022.12.22 Made abstract class from `rocksdb_settings_plugin`.
////////////////////////////////////////////////////////////////////////////////
#pragma once
...
template <typename DatabaseBackend>
class debby_settings_plugin: public abstract_settings_plugin
{
protected:
    using database_type = debby::keyvalue_database<DatabaseBackend>;
...
public:
    debby_settings_plugin (pfs::filesystem::path const & db_path)
